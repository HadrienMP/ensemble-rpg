...
toElement : String -> List (Svg msg) -> Element msg
toElement viewBoxValue svgImage =
    svg
        [ attribute "version" "1.1"
        , viewBox viewBoxValue
        , Svg.Attributes.fill <| printColor Color.Dracula.white
